...
class Proofread2Workflow:
    ...
    def build_prompt_for_batch(self, batch: List[TranslationBlock]) -> str:
        ...
        prompt = (
            "你是中文 D&D 译文二校员。你熟悉dnd的中文翻译与术语，基于当前翻译稿件与质量不好的一校给出的译文与建议做最终二校，确保其中的语义符合英文原意，将一校那许多翻译腔改为正常汉语语序，力求清晰易懂。\n"
            "\n"
            "【术语约束】\n"
            "1) 在术语表内术语符合当前文中语义环境时，优先遵循旧术语表。\n"
            ...
            "proofread_note 写修改原因及文中出现的术语；如果该段应该合并至前段，则在这里写出合并至前段。\n"
            "\n"
            "[\n"
